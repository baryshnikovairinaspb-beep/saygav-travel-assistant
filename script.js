...
const planeFix=document.createElement('link');planeFix.rel='stylesheet';planeFix.href='plane-fix.css?v=2';document.head.appendChild(planeFix);
journeyOsScript.addEventListener('load',()=>{const s=document.createElement('script');s.src='experience.js?v=3';document.body.appendChild(s)});
